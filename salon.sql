...
INSERT INTO public.appointments VALUES (7, 12, 1, '10:20');
INSERT INTO public.appointments VALUES (14, 123, 1, '10:30');
INSERT INTO public.appointments VALUES (15, 123, 2, '11am');
INSERT INTO public.appointments VALUES (16, 124, 5, '4:40');
...
INSERT INTO public.customers VALUES (1, '1-1', 'zap');
INSERT INTO public.customers VALUES (123, '555-555-5555', 'Fabio');
INSERT INTO public.customers VALUES (124, '44-44', 'mathew');
INSERT INTO public.customers VALUES (12, '123', 'asd');
...
SELECT pg_catalog.setval('public.appointments_appointement_id_seq', 28, true);
...
--
-- Name: appointments customer_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: appointments service_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT service_id_fk FOREIGN KEY (service_id) REFERENCES public.services(service_id);
